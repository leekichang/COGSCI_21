...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='G:\\내 드라이브\\2021-1 강의\\IIT1301 인지과학\\psychopy\\project1\\test1.py',
...
for thisTrial in trials:
    ...
    trialComponents = [key_resp, stdline, testline, leftup, leftdown, rightup, rightdown]
    ...
    thisExp.addData('leftup.started', leftup.tStartRefresh)
    thisExp.addData('leftup.stopped', leftup.tStopRefresh)
    thisExp.addData('leftdown.started', leftdown.tStartRefresh)
    thisExp.addData('leftdown.stopped', leftdown.tStopRefresh)
    thisExp.addData('rightup.started', rightup.tStartRefresh)
    thisExp.addData('rightup.stopped', rightup.tStopRefresh)
    thisExp.addData('rightdown.started', rightdown.tStartRefresh)
    thisExp.addData('rightdown.stopped', rightdown.tStopRefresh)
